...
// SQL Server Extension Sample Code: $connectionInfo = array("UID" => "rse", "pwd" => 'Pa$$w0rd1234', "Database" => "ibrot", "LoginTimeout" => 30,
  "Encrypt" => 1, "TrustServerCertificate" => 0); 
$serverName = "tcp:rse-ibrot-dbsrv.database.windows.net,1433"; 
